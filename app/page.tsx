      ...
      <section className="relative py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-2xl p-12 bg-gradient-to-br from-white/6 to-transparent border border-white/6 shadow-2xl backdrop-blur-md overflow-hidden">
            {/* Decorative accent */}
            <svg className="absolute -top-10 -right-10 w-72 h-72 opacity-40 blur-2xl transform rotate-12" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden>
              <defs>
              ...
              <path fill="url(#g1)" d="M43.6,-69.9C57.1,-62.3,68.5,-52.1,74.7,-38.7C81,-25.3,82,-8.6,78.9,7.5C75.8,23.6,68.6,38.3,58.1,49C47.6,59.7,33.9,66.4,19.5,72.2C5.1,78,-9.2,82.8,-22.9,80.2C-36.6,77.6,-49.7,67.6,-58.7,54.9C-67.7,42.1,-72.7,26.6,-75.6,9.9C-78.5,-6.8,-79.3,-24.5,-70.2,-35.6C-61.2,-46.6,-42.2,-51,-24.4,-58.4C-6.6,-65.7,8.8,-76.6,23.6,-77.8C38.5,-79,52.8,-70.5,43.6,-69.9Z" transform="translate(100 100)" />
            </svg>
            <div className="relative z-10 text-center space-y-6">
              <div className="flex flex-wrap justify-center gap-3">
                <Badge className="bg-primary/20 text-primary px-3 py-1 rounded-full">JNTUK Affiliated</Badge>
                <Badge className="bg-secondary/20 text-secondary px-3 py-1 rounded-full">AICTE Approved</Badge>
                <Badge className="bg-accent/20 text-accent px-3 py-1 rounded-full">NAAC 'A' Grade</Badge>
              </div>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent drop-shadow-sm">Sir C.R. Reddy College of Engineering</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">Autonomous Institution Committed to Excellence in Engineering Education</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
                ...
                <Link href="https://sircrrcoestd.in/">
                  <Button size="lg" variant="outline" className="gap-2 smooth-button border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/8 hover:shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-6 mt-10">
          ...
          <h1 className={`text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight smooth-transition ${isLoaded ? 'slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">Your Work Matters.</span>
            <span className="block text-3xl sm:text-4xl font-semibold mt-2 bg-gradient-to-r from-primary via-purple-500 to-accent bg-clip-text text-transparent drop-shadow-sm">Your Campus Sees You.</span>
            ...
            {[
              ...
              return (
                <Link href={item.href} key={item.title}>
                  <Card className={`p-6 smooth-transition cursor-pointer h-full group backdrop-blur-sm border-primary/20 rounded-xl transform transition duration-300 hover:scale-105 hover:shadow-2xl ${item.href === '/ai-generator' ? 'bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/30' : 'bg-card/50 hover:bg-card/70'}`}
                    style={{ animationDelay: `${idx * 0.1}s` }}>
